...
public class Utilidades {
    ...
    public static final String CAMPO_FOTO = "image";


    public static final String CREAR_TABLA_ALUMNO="CREATE TABLE "+TABLA_ALUMNO+" ("+CAMPO_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+CAMPO_NOMBRE+" TEXT, "+CAMPO_CIUDAD_NAC+" TEXT, "+CAMPO_MATRICULA+" TEXT, "+CAMPO_EXP_CREATIVA+" TEXT, "+CAMPO_FOTO+" BLOB)";
